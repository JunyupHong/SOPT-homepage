...
const ActivityContent = () => {
    return (
        <>
            ...
            <Styled.CardWrapper>
                <Styled.Card>
                    <Styled.CardImg src='/assets/images/aboutpage/activity_5.png' alt='activity-1' />
                ...
                <Styled.Card>
                    <Styled.CardImg src='/assets/images/aboutpage/activity_5.png' alt='activity-2' />
                ...
                <Styled.Card>
                    <Styled.CardImg src='/assets/images/aboutpage/activity_5.png' alt='activity-3' />
                ...
                <Styled.Card>
                    <Styled.CardImg src='/assets/images/aboutpage/activity_5.png' alt='activity-4' />
                ...
                <Styled.Card>
                    <Styled.CardImg src='/assets/images/aboutpage/activity_5.png' alt='activity-6' />
